...
helm upgrade --install vault hashicorp/vault --namespace=vault --version=0.24.1 --set server.dev.enabled=true --set injector.enabled=false --set server.image.tag="1.13.1"
