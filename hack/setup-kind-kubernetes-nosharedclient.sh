...
helm upgrade --install vault hashicorp/vault --namespace=vault --version=0.32.0 --set server.dev.enabled=true --set injector.enabled=false --set server.image.tag="1.21.2"
