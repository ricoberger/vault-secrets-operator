...
helm upgrade --install vault hashicorp/vault --namespace=vault --version=0.22.1 --set server.dev.enabled=true --set injector.enabled=false --set server.image.tag="1.11.5"
