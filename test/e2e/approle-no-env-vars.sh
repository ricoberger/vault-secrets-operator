...
helm upgrade --install vault hashicorp/vault --namespace=vault --version=0.34.0 --set server.dev.enabled=true --set injector.enabled=false --set server.image.tag="2.0.4"
