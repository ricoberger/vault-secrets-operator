...
func (in *JksSpec) DeepCopyInto(out *JksSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JksSpec.
func (in *JksSpec) DeepCopy() *JksSpec {
	if in == nil {
		return nil
	}
	out := new(JksSpec)
